...
function getCateById($id){
	$sql="select id,cName from MFY_cate where id={$id}";
	return fetchOne($sql);
}
 ...
 */
function getAllCate(){
	$sql="select id, cName from MFY_cate";
	$rows=fetchAll($sql);
	return $rows;
}
